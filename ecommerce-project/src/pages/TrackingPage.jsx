...
export function TrackingPage({ cart }) {
  ...
  let progressPercent = Math.min((timePassedMs / totalDeliveryTime) * 100, 100);
    ...
    <>
      ...
      <div className="tracking-page">
        <div className="order-tracking">
          ...
          <div className="delivery-date">Arriving on {dayjs(orderProduct.estimatedDeliveryTimeMs).format(
            "dddd, MMMM D"
          )}</div>
          ...
          <div className="progress-labels-container">
            ...
            <div className={`progress-label ${isDelivered && 'current-status'}`}>{progressPercent >= 100 ? 'Delivered on' : 'Arriving on'}</div>
          </div>
